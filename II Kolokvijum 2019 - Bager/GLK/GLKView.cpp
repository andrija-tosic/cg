...
void CGLKView::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	...
	if (nChar == VK_UP) m_glRenderer.upViewRot += 5;
	if (nChar == VK_DOWN) m_glRenderer.upViewRot -= 5;

	if (nChar == 'W') m_glRenderer.viewZoom += 1;
	if (nChar == 'S') m_glRenderer.viewZoom -= 1;
	
	if (nChar == '1') m_glRenderer.bodyRot -= 5;
	if (nChar == '2') m_glRenderer.bodyRot += 5;
	
	if (nChar == '3') m_glRenderer.arm1Rot -= 5;
	if (nChar == '4') m_glRenderer.arm1Rot += 5;

	if (nChar == '5') m_glRenderer.arm2Rot -= 5;
	if (nChar == '6') m_glRenderer.arm2Rot += 5;

	if (nChar == '7') m_glRenderer.forkRot -= 5;
	if (nChar == '8') m_glRenderer.forkRot += 5;
